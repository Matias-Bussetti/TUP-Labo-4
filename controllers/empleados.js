...
const getEmpleados = (req = request, res = response) => {
  ...
  axios
    .get(
      `https://66c78f59732bf1b79fa6e8c7.mockapi.io/api/v1/empleados${filtro}`
    )
    .then((response) => {
      const { data = [] } = response;
      // handle success
...
const getEmpleadoOld = (req = request, res = response) => {
  ...
  axios
    .get("https://66c78f59732bf1b79fa6e8c7.mockapi.io/api/v1/empleados")
    .then((response) => {
      const { data } = response;
...
const getEmpleado = (req = request, res = response) => {
  ...
  axios
    .get(
      `https://66c78f59732bf1b79fa6e8c7.mockapi.io/api/v1/empleados/${idEmpleado}`
    )
    .then((response) => {
      const { data } = response;
      res.status(200).json({
